...
SELECT 
DAY_ACTIVE_WALLETS,
DAY_ACTIVE_WALLETS/(SELECT arbone_day_active_wallets FROM total) AS PCT_DAY_ACTIVE_WALLETS,
DAY_GAS_SPEND,
DAY_GAS_SPEND/(SELECT arbone_day_gas_spend FROM total) AS PCT_DAY_GAS_SPEND,
WEEK_ACTIVE_WALLETS,
WEEK_ACTIVE_WALLETS/(SELECT arbone_week_active_wallets FROM total) AS PCT_WEEK_ACTIVE_WALLETS,
WEEK_GAS_SPEND,
WEEK_GAS_SPEND/(SELECT arbone_week_gas_spend FROM total) AS PCT_WEEK_GAS_SPEND,
